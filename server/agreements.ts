...
export const DEFAULT_AGREEMENT_TEMPLATE = [
  ...
  "Subscriber agrees to pay the recurring Subscription Fee of {{price}} per month. Fees are billed in advance on a recurring monthly cycle via Stripe. Charges continue automatically until canceled in accordance with Section 8. Subscription fees are non-refundable except as required by law.",
  "",
  "3. PROPRIETARY DATA OWNERSHIP & NON-SALE GUARANTEE",
  ...
  "",
  "4. REAL ESTATE WHOLESALING & STATUTORY NON-AGENCY DISCLAIMER",
  ...
  "",
  "8. TERM, CANCELLATION & 30-DAY RETENTION",
  ...
  "",
  "11. ELECTRONIC SIGNATURE ACKNOWLEDGEMENT",
