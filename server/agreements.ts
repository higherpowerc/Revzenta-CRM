...
export const DEFAULT_AGREEMENT_TEMPLATE = [
  ...
  "(d) Subscriber Sole Duty for State-Specific Wholesaling Compliance: Real estate wholesaling laws, licensing thresholds, advertising guidelines, and contract assignment statutes vary significantly across state and municipal jurisdictions. It is the sole, affirmative duty of Subscriber to understand and strictly follow all lawful practices and state-specific statutory guidelines governing wholesaling in each jurisdiction where Subscriber transacts business.",
  "(e) No Legal Defense or Representation: Revzenta does NOT defend, represent, counsel, or indemnify Subscriber against state-specific laws, regulatory investigations, real estate licensing board citations, statutory penalties, or civil/criminal proceedings arising from Subscriber's wholesaling activities. Subscriber assumes 100% legal and financial responsibility for its transactions and covenants to indemnify and hold harmless Provider from any claims or enforcement actions arising therefrom.",
  "",
