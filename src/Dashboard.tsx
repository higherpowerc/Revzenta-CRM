      ...
      {ownerOrg && !isPropView ? (
        <div className="kpi-row">
          ...
          <div className="card kpi">
            ...
            <span className="kpi-value lime">{saas.activeSubscribers}</span>
            <span className="kpi-note">{saas.totalSubscribers} registered · 100% Private &amp; Isolated</span>
            {onGoToSubscribers && (
              <button
                className="link-btn"
                onClick={onGoToSubscribers}
      ...
      {ownerOrg && !isPropView ? (
        <>
            ...
            <div className="card dashboard-window">
              <div>
                ...
                <div className="window-stat-grid">
                  ...
                  <div className="window-stat-card">
                    <div className="window-stat-label">Total Workspaces</div>
                    <div className="window-stat-value" style={{ color: "var(--ink)" }}>
                      {saas.totalSubscribers}
                    </div>
                  </div>
                  <div className="window-stat-card">
                      ...
                      <div key={sub.id} className="window-item-card" style={{ cursor: "default" }}>
                        <div style={{ maxWidth: "60%", overflow: "hidden" }}>
                          ...
                          <div className={`window-item-sub ${blurPii(pii)}`}>
                            {sub.adminEmail || "Admin User"} · Private Isolated Workspace
                          </div>
                        </div>
            ...
            <div className="card dashboard-window">
              <div>
                ...
                <div className="window-list-stack">
                  ...
                  <div className="window-item-card" style={{ cursor: "default" }}>
                    <div style={{ maxWidth: "70%" }}>
                      <div className="window-item-title">Tenant Data Privacy &amp; Isolation</div>
                      <div className="window-item-sub">
                        Zero-Knowledge Architecture: Subscriber leads, properties &amp; assignment fees remain 100% private
                      </div>
                    </div>
                    <div style={{ textAlign: "right" }}>
                      <div className="window-item-val" style={{ color: "var(--lime, #3fb950)" }}>
          ...
          <div className="dashboard-windows-row">
            ...
            {/* Window 4: Tenant Security & Privacy Architecture */}
            <div className="card dashboard-window">
              <div>
                <WindowHead
                  icon="🛡️"
                  title="Tenant Security & Privacy Architecture"
                  badgeText="Zero-Knowledge"
                  badgeTone="tone-lime"
                  subtitle="Enterprise multi-tenant boundary: subscriber leads, seller contacts & deal margins are strictly isolated"
                />

                <div className="window-stat-grid">
                  <div className="window-stat-card">
                    <div className="window-stat-label">Tenant Isolation</div>
                    <div className="window-stat-value" style={{ color: "var(--lime, #3fb950)" }}>
                      100% Active
                    </div>
                  </div>
                  <div className="window-stat-card">
                    <div className="window-stat-label">Data Privacy</div>
                    <div className="window-stat-value" style={{ color: "var(--primary, #d6ff3f)" }}>
                      Zero-Knowledge
                    </div>
                  </div>
                ...
                <div className="window-list-stack">
                  <div className="window-item-card" style={{ cursor: "default" }}>
                    <div style={{ maxWidth: "70%" }}>
                      <div className="window-item-title">Row-Level Tenant Partitioning</div>
                      <div className="window-item-sub">
                        Every lead, seller contact, contract, and escrow record is partitioned by organization ID and shielded from cross-tenant access.
                      </div>
                    </div>
                    <div style={{ textAlign: "right" }}>
                      <div className="window-item-val" style={{ color: "var(--lime, #3fb950)" }}>
                  ...
                  <div className="window-item-card" style={{ cursor: "default" }}>
                    <div style={{ maxWidth: "70%" }}>
                      <div className="window-item-title">Confidentiality Guarantee</div>
                      <div className="window-item-sub">
                        Revzenta never inspects, aggregates, or monetizes subscriber deal values, assignment fees, or private real estate transactions.
                      </div>
                    </div>
                    <div style={{ textAlign: "right" }}>
                      <span className="badge tone-purple" style={{ fontSize: "0.68rem" }}>
              ...
              <div className="dashboard-window-footer">
                ...
                <span>{saas.activeSubscribers} Workspaces Protected Under Zero-Knowledge Isolation</span>
              </div>
            </div>
          </div>
        </>
