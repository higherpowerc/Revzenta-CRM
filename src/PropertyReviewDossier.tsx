        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              {titleBadge && <span style={{ fontSize: "13px", color: "var(--muted, #94a3b8)" }}>{titleBadge} /</span>}
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "6px", fontSize: "12.5px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <strong style={{ color: "var(--ink, #f8fafc)" }}>{property.phone || "No phone recorded"}</strong>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ color: "var(--muted, #94a3b8)" }}>Email:</span>
                <strong style={{ color: "var(--ink, #f8fafc)" }}>{property.email || "No email recorded"}</strong>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <div style={{ marginTop: "16px" }}>
                ...
                <div style={{ marginBottom: "18px" }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "10px", textAlign: "center" }}>
                    ...
                    <div style={{ padding: "10px", borderRadius: "8px", background: "rgba(0,0,0,0.2)", border: "1px solid var(--border-color, #334155)" }}>
                      <div style={{ fontSize: "11px", color: "var(--muted, #94a3b8)" }}>Motivation Level</div>
                      <div style={{ fontSize: "18px", fontWeight: 700, color: "#3b82f6" }}>
                        {explanation.opportunityScoreBreakdown.distressScore}/35
                      </div>
                    </div>
                    <div style={{ padding: "10px", borderRadius: "8px", background: "rgba(0,0,0,0.2)", border: "1px solid var(--border-color, #334155)" }}>
                      <div style={{ fontSize: "11px", color: "var(--muted, #94a3b8)" }}>Spread Feasibility</div>
